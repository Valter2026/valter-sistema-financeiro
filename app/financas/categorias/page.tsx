    ...
    <div>
      ...
      {loading ? (
        ...
        <div className="bg-gray-900 rounded-xl border border-gray-800 py-16 text-center">
          <p className="text-gray-500 text-sm">Nenhuma categoria de {aba === 'expense' ? 'despesa' : 'receita'} cadastrada.</p>
        </div>
      ) : (
                ...
                <div className="flex items-center justify-between px-5 py-3.5 border-b border-gray-800 hover:bg-gray-800 transition-colors">
                  ...
                  <div className="flex items-center gap-1">
                    <button onClick={() => setForm({ type: aba, color: COLORS[0], parent_id: pai.id })}
                      className="px-2 py-1 rounded-lg text-xs text-blue-400 hover:bg-blue-950 font-medium transition-colors">
                      + sub
                    </button>

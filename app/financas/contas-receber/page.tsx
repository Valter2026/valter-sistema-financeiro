      ...
      <div className="bg-gray-900 rounded-xl border border-gray-800 overflow-hidden">
        {loading ? (
          ...
          <div className="py-16 text-center">
            ...
            <p className="text-gray-500 text-sm">Nenhum recebimento pendente!</p>
          </div>
        ) : (
          <table className="w-full text-sm">
            ...
            <tbody>
              {lista.map((tx, i) => {
                ...
                return (
                  <tr key={tx.id ?? i} className={`border-b border-gray-800 hover:bg-gray-800 transition-colors ${atrasada ? 'bg-yellow-950/10' : ''}`}>
                    ...
                    <td className="px-5 py-3.5 text-right font-bold text-green-400">{formatCurrency(Number(tx.amount))}</td>
                    <td className="px-5 py-3.5">
                      {atrasada ? (
                        ...
                        <span className="inline-flex items-center gap-1 px-2.5 py-1 rounded-full text-xs font-semibold bg-blue-950 text-blue-400 border border-blue-800">
            ...
            <tfoot>
              <tr className="border-t-2 border-gray-700 bg-gray-800/50">
                ...
                <td className="px-5 py-3 text-right font-bold text-green-400">{formatCurrency(totalLista)}</td>
                <td colSpan={2} />
              </tr>
            </tfoot>
          </table>

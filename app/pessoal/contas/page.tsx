...
const TYPES: Record<string, { label: string; icon: any }> = {
  ...
  cash:        { label: 'Dinheiro/Carteira', icon: Banknote   },
...
export default function PfContasPage() {
  ...
  const load = useCallback(async () => {
    setLoading(true)
    const data = await fetch('/api/pf/accounts').then(r => r.json())
            ...
            return (
              <div key={acc.id} className="bg-gray-900 rounded-xl border border-gray-800 p-5 hover:border-gray-700 transition-colors">
                <div className="flex items-start justify-between mb-4">
                  <div className="flex items-center gap-3">
                    <div className="p-2.5 rounded-xl bg-gray-800">
                      <Icon size={18} style={{ color: acc.color ?? '#10b981' }} />
                    </div>
                    <div>
                ...
                <div className="border-t border-gray-800 pt-3">
                  ...
                  <p className="text-xl font-bold" style={{ color: acc.color ?? '#10b981' }}>
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm">
          <div className="bg-gray-900 rounded-2xl shadow-2xl w-full max-w-md border border-gray-800">
            ...
            <div className="p-6 space-y-4">
              ...
              <div>
                <label className="text-xs font-semibold text-gray-400 uppercase tracking-wide">Saldo Atual (R$)</label>
